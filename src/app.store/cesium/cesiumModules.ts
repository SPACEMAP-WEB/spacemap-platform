...
export const turnOffPathNLabel = ({
  ...
  primarySat.path.show = { ...property, isConstant: false }
  primarySat.label.show = { ...property, isConstant: false }
  secondarySat.path.show = { ...property, isConstant: false }
  secondarySat.label.show = { ...property, isConstant: false }
}
